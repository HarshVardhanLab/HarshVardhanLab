<!-- Dynamic Banner with Profile Photo -->
<p align="center">
...
<h1 align="center">👋 Hey there, I'm Harsh Vardhan</h1>
<h3 align="center">🚀 AI OS Developer | 🛡️ Security Researcher | 🔓 Open Source Advocate</h3>
...
### 🌟 About Me
- 🧠 Building an **AI-powered Operating System** from scratch.
- 🛡️ Exploring the depths of **cybersecurity and malware analysis**.
- 🛠️ Always experimenting with **automation, system-level projects**, and **AI + OS integration**.
- 💬 Passionate about knowledge sharing through **workshops, hackathons**, and **open source**.
...
<table>
  <tr>
    <td width="50%" align="center">
      ...
      <p>Custom-built OS with AI capabilities and security modules.</p>
    ...
    <td width="50%" align="center">
      ...
      <p>Complete cybersecurity toolkit for learning and testing.</p>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,c,cpp,java,bash,linux,django,react,nodejs,docker,arduino,azure,gcp,git,mongodb,mysql,postgresql,tailwind&perline=10" alt="Tech Stack"/>
</p>
...
```python
def collaborate(idea):
    if idea in ["innovative", "security-related"]:
        return "📧 Email me at harshvardhan02102002@gmail.com"
    elif idea == "open-source":
        return "🔀 Fork & Open a PR on GitHub"
    else:
        return "💬 DM me on Twitter @harshvardha"
